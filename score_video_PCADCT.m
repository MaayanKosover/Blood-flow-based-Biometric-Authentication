...
%%
function counter_s = score_video_PCADCT(PCA_output,DCT_output,numOfPCAcoeff, numOfDCTcoeff)
%% PCA+DCT - 2 Tests
   numOfSubjects = 7;
   sz = size(DCT_output);
   ...
   PCADCT1_1 = [PCA1_1.' DCT1_1_cut];
   PCADCT2_1 = [PCA2_1.' DCT2_1_cut];
   PCADCT3_1 = [PCA3_1.' DCT3_1_cut];
   PCADCT4_1 = [PCA4_1.' DCT4_1_cut];
   PCADCT5_1 = [PCA5_1.' DCT5_1_cut];
   PCADCT6_1 = [PCA6_1.' DCT6_1_cut];
     
   % build the train set
   numOfTests = 2;
   X = [];
   for i=(1:numOfSubjects)
        X = [X;PCADCT1_1(i,:);PCADCT2_1(i,:);PCADCT3_1(i,:);
            PCADCT4_1(i,:)];        
   end  
    ...
    for i=(1:numOfSubjects) % build test set (size numOfTests)
        test = [test;PCADCT5_1(i,:);PCADCT6_1(i,:)];       
    end       
